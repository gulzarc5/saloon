                                        ...
                                        <table class="table table-striped jambo_table bulk_action">
                                            <thead>
                                                <tr style="font-size: 10.5px;">
                                                    ...
                                                    <th>M.R.P.</th>
                                                    <th>Price</th>
                                                    <th style="min-width: 178px;">Service Available</th>
                                                    <th>Status</th>
                                                    <th>Action</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                @foreach ($client_services as $service)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="mrp[]" value="{{$service->mrp}}" style="width: 70px;">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="price[]" value="{{$service->price}}" style="width: 70px;">
                                                        </td>
                                                        <td>
